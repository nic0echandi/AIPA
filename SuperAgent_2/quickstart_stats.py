...
Ejecuta esto después de instalar SuperAgent_2 para verificar que todo funciona.
"""
...
def main():
    ...
    if summary['total'] > 0:
        ...
        print("  (Sin datos aún - comienza a procesar emails con superagent_2.py)")
    
    # 3. Instrucciones
    print_section("Próximos pasos")
    
    print("1️⃣  Ejecutar SuperAgent_2 en background:")
    print("   cd SuperAgent_2")
    print("   nohup python superagent_2.py > logs/agent.log 2>&1 &")
    ...
    print("❓ ¿No veo datos?")
    print("   → Asegúrate de que SuperAgent_2 está ejecutándose")
    print("   → Coloca archivos .txt en ingress/")
    print("   → Verifica logs/superagent_2.log")
...
if __name__ == "__main__":
    try:
        ...
        print(f"\n❌ Error: {e}")
        print("\nVerifica que estés en el directorio SuperAgent_2/")
        sys.exit(1)
