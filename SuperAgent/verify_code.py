...
# Verificar que extract_email_from_address esté en superagent.py
try:
    with open("superagent.py", "r") as f:
        superagent_source = f.read()
    
    if 'html.unescape' in superagent_source:
        print("  ✓ Decodificación HTML presente en superagent.py")
    else:
        print("  ✗ Decodificación HTML NO encontrada en superagent.py!")
except Exception as e:
    print(f"  ✗ Error verificando superagent.py: {e}")
